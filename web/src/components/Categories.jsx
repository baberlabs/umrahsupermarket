      ...
      <div className="container">
        <div className="cats__head">
          <div>
            ...
            <p className="cats__sub">Browse the best of our diverse grocery selection. Click on a category to start exploring.</p>
          </div>
          <Link to="/categories" className="cats__see-all">View all →</Link>
        </div>
        ...
        <div className="cats__grid">
          {shown.map(cat => (
            ...
            >
              <img src={cat.image} alt={cat.label} className="cats__card-img" loading="lazy" />
