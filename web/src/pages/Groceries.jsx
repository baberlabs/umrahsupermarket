...
export default function Groceries() {
  ...
  const activeCatLabel =
    categories.find((c) => c.id === activeCat)?.label || "All Products";
  ...
  return (
    <main className="groc">
      ...
      {heroCard ? (
        <div
          className="groc__hero"
          style={{ "--hero-img": `url(${heroCard.image})` }}
        >
                ...
                {PRICE_RANGES.map((r) => (
                  <li key={r.label}>
                    <button
                      ...
                      onClick={() =>
                        setPriceFilter(
                          priceFilter?.label === r.label ? null : r,
                        )
                      }
                    >
                      <span className="groc__filter-check">
          ...
          {paginated.length > 0 && (
            <div className="groc__bottom-panels">
              <div className="groc__popular">
                ...
                <div className="groc__popular-grid">
                  {products
                    .filter(
                      (p) =>
                        p.badge === "Top Rated" || p.badge === "Best Seller",
                    )
                    .slice(0, 2)
                    .map((p) => (
                      <div key={p.id} className="groc__popular-card">
                        ...
                        <div>
                          ...
                          <p className="groc__popular-price">
                            £{p.price.toFixed(2)}
                          </p>
                        </div>
                      </div>
              ...
              <div className="groc__guide">
                <h3 className="groc__panel-title">
                  A Guide to Halal Standards
                </h3>
                <p className="groc__guide-intro">
                  All meat at Umrah is certified by a recognised UK halal
                  authority.
                </p>
                <ul className="groc__guide-list">
                  <li>
                    <strong>Hand-slaughtered:</strong> Individual slaughter with
                    prayer, as required.
                  </li>
                  <li>
                    <strong>No stunning:</strong> Unless specifically requested
                    and certified permissible.
                  </li>
                  <li>
                    <strong>Full traceability:</strong> Farm-to-counter records
                    available on request.
                  </li>
                  <li>
                    <strong>Weekly audits:</strong> Our suppliers undergo
                    regular certification checks.
                  </li>
                </ul>
              </div>
            </div>
