...
const hours = [
  { day: 'Monday – Friday',  time: '8:00am – 9:00pm' },
      ...
      <div className="container contact__layout">
        ...
        <div className="contact__info">
          <div className="contact__info-card">
            ...
            <div>
              <h3>Our Store</h3>
              <p>123 Alum Rock Road</p>
              <p>Birmingham, B8 1JL</p>
          ...
          <div className="contact__info-card">
            ...
            <div>
              <h3>Phone</h3>
              <a href="tel:01210000000">0121 000 0000</a>
              <p className="contact__info-note">Mon–Fri 8am–8pm</p>
            </div>
          </div>
          ...
          <div className="contact__info-card">
            ...
            <div>
              <h3>Email</h3>
              <a href="mailto:hello@umrahsupermarket.co.uk">hello@umrahsupermarket.co.uk</a>
          ...
          <div className="contact__hours">
            ...
            <div className="contact__hours-note">
              ...
              <span>Open now — closing at 9:00pm</span>
            </div>
          </div>
          ...
          <div className="contact__map">
            <div className="contact__map-inner">
              <span>🗺️</span>
              <p>123 Alum Rock Road, B8 1JL</p>
              <a
                href="https://maps.google.com/?q=Alum+Rock+Road+Birmingham"
                target="_blank"
        ...
        <div className="contact__form-wrap">
          <div className="contact__form-header">
            ...
            <p>Fill out the form and we'll get back to you within one working day.</p>
          </div>
          ...
          {status === 'success' ? (
            <div className="contact__success">
              ...
              <h3>Message sent!</h3>
              <p>Thanks for getting in touch. We'll reply to <strong>{form.email || 'you'}</strong> within 24 hours.</p>
      ...
      <section className="contact__social-strip">
        <div className="container">
          ...
          <div className="contact__social-links">
            <a href="#" className="contact__social-btn">📘 Facebook</a>
            <a href="#" className="contact__social-btn">📷 Instagram</a>
            <a href="#" className="contact__social-btn">💬 WhatsApp</a>
          </div>
        </div>
      </section>
    </main>
